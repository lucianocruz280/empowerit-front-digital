...
const ModalUploadLesson: FC<Props> = (props) => {
  ...
  const uploadLive = async () => {
    try {
      ...
      const lesson: any = {
        ...
        order: props.orderIndex,
        image_cover: null,
      }

      const url = await uploadImage(
        'image_cover',
        'courses-leadership/' + props.courseId + '/lessons/' + lessonId,
        image_cover
      )
      ...
      const ref = doc(db, 'courses-leadership/' + props.courseId + '/lessons/' + lessonId)
...
export default ModalUploadLesson
